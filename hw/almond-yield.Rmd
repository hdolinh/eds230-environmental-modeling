...
# had to add "d" as a dummy column to get the data lined up correctly
...
```{r}
almond_yield <- function(temp_min, precip){
  
  ((-0.015 * temp_min) - (-0.0046 * temp_min^2)) - ((0.07 * precip) + (0.0043 * precip^2)) + 0.28
}
```
